...
import static com.example.zebra_scanner.ZebraScannerPlugin.scannerInfoList;
import static com.example.zebra_scanner.ZebraScannerPlugin.sdkHandler;
...
//        deviceBluetoothAddress.setText("78:B8:D6:B1:F3:C8");
...
//            "78:B8:D6:B1:F3:C8"
    ...
    private void generatePairingBarcode() {
        LinearLayout.LayoutParams layoutParams = new LinearLayout.LayoutParams(-1, -1);
        BarCodeView barCodeView = sdkHandler.dcssdkGetPairingBarcode(DCSSDKDefs.DCSSDK_BT_PROTOCOL.SSI_BT_SSI_SLAVE, DCSSDKDefs.DCSSDK_BT_SCANNER_CONFIG.SET_FACTORY_DEFAULTS, "78:B8:D6:B1:F3:C8");
